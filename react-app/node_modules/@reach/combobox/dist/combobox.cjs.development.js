...
var Combobox = /*#__PURE__*/utils.forwardRefWithAs(function Combobox(_ref, forwardedRef) {
  ...
  return React__default['default'].createElement(descendants.DescendantProvider, {
    ...
    items: options,
    set: setOptions
  }, React__default['default'].createElement(ComboboxContext.Provider, {
    value: context
...
var ComboboxPopover = /*#__PURE__*/React.forwardRef(function ComboboxPopover(_ref3, forwardedRef) {
  ...
  return portal ? React__default['default'].createElement(Popover__default['default'], Object.assign({}, props, {
    ref: ref,
    position: position,
    targetRef: inputRef
  }, sharedProps)) : React__default['default'].createElement("div", Object.assign({
    ref: ref
  }, props, sharedProps));
});
...
var ComboboxOption = /*#__PURE__*/utils.forwardRefWithAs(function ComboboxOption(_ref5, forwardedRef) {
  ...
  return React__default['default'].createElement(OptionContext.Provider, {
    value: {
      value: value,
      index: index
    }
  }, React__default['default'].createElement(Comp, Object.assign({
    ...
    tabIndex: -1,
    onClick: utils.wrapEvent(onClick, handleClick),
    children: children || React__default['default'].createElement(ComboboxOptionText, null)
  })));
});
...
function ComboboxOptionText() {
  ...
  return React__default['default'].createElement(React__default['default'].Fragment, null, results.length ? results.map(function (result, index) {
